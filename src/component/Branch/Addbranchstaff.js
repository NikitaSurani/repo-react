...
const AddBranchStaff = () => {
    ...
    const AddData = (e) => {
        ...
        Axios.post("https://node-knz.herokuapp.com/addstaff", staffdata)
            .then((res) => {
                if (res.status === 200) {
    ...
    useEffect(() => {
        if (id) {
            Axios.get(`https://node-knz.herokuapp.com/editstaffdata/${id}`)
                .then((res) => {
    ...
    const editData = (e) => {
        ...
        const { staffname, staffemail, branchname, staffaddress, city, contactnumber } = staff;
        const staffdata = { staffname, staffemail, branchname, staffaddress, city, contactnumber };
        Axios.put(`https://node-knz.herokuapp.com/updateStaffData/${id}`, staffdata)
            .then((res) => {
                if (res.status === 200) {
