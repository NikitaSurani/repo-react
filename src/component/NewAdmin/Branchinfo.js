            ...
            buttons: [
                {
                    label: 'Yes',
                    onClick: () => {
                        Axios.delete(`https://node-knz.herokuapp.com/deleteBranchData/${id}`)
                            .then((res) => {
                                Axios.get("https://node-knz.herokuapp.com/branchinfo")
                                    .then((res) => {
                                        SetData(res.data.branchData);
                    ...
                    <nav className="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl bg-gray" id="navbarBlur" navbar-scroll="true">
                        <div className="container-fluid py-1 ">
                            <nav aria-label="breadcrumb">
                                <h6 className="font-weight-bolder mb-0 mainad" style={{marginLeft:"-36px"}}>Branch</h6>
                            </nav>
                    ...
                    <div className="container-fluid ">
                        <div className="row reshead" >
                            <div className="col-md-12 col-sm-12 mr-auto">
                                <h3 style={{marginLeft:"-1039px"}}>Branch Detail</h3>
                            </div>
                          </div>  
