...
const Usertrackparcel = () => {
    ...
    //     let isValid = true;
    //     if (!ref.reference ||  {
    //         err.reference= "Field Can-Not Be Empty";
    //         isValid = false;
    //         console.log(isValid);
    //     }
    //     else if (typeof ref.reference !== "undefined") {
    //         if (!ref.reference.trim().match(/^[0-9, ]+$/)) {
    //             err.reference = "Please Enter  Digit";
    //             isValid = false;
    //         }
    //     }
    //     else {
                                    ...
                                    captcha === "captcha" ? (
                                        <>
                                            <div className='capspan'>
                                                <p className='captchabg' >{dataresult}</p>
