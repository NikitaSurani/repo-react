...
const Receiveparcel = () => {
  ...
  useEffect(() => {
    if (getBranchToken) {
      Axios.get("https://node-knz.herokuapp.com/branchloggedin", { headers: { 'authorization': getBranchToken } })
        .then((res) => {
  ...
  const assignparcel = (e, id) => {
    if (!isActive && assignto) {
      ...
      Axios.put(`https://node-knz.herokuapp.com/updateparcelstatus/${id}`, assignd)
        .then((res) => {
          Axios.get(`https://node-knz.herokuapp.com/branchparceldata/${branchname}`)
            .then((res) => {
              setData(res.data.branchinfo);
  ...
  const editstus = (e, id,pastatus) => {
    ...
    Axios.put(`https://node-knz.herokuapp.com/updatebranchparcelstatus/${id}`, {branchparcelstatus})
      .then((res) => {
        Axios.get(`https://node-knz.herokuapp.com/branchparceldata/${branchname}`)
          .then((res) => {
            setData(res.data.branchinfo);
