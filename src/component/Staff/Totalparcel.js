...
const Totalparcel = () => {
    ...
    useEffect(() => {
        if (getstaffToken) {
            Axios.get("https://node-knz.herokuapp.com/sloggedin", {
                ...
                Axios.get(`https://node-knz.herokuapp.com/staffparceldata/${username}`)
                    .then((res) => {
    ...
    const editstus = (e, id, pastatus) => {
        ...
        Axios.put(`https://node-knz.herokuapp.com/updatestaffparcelstatus/${id}`, { branchparcelstatus })
            .then((res) => {
    ...
    const displaysusers = data
        ...
        .map((info) => (
            <tr key={info._id} className='tbltr'>
                ...
                {/* <td>
                    <button className='staffupdatebtn' onClick={(e) => editstus(e, info._id, info.branchparcelstatus)} >UnDelivered</button>
                </td> */}
